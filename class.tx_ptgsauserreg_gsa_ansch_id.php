...
/**
 * Class/Function which manipulates the item-array for table/field gsa_ansch_id.
 *
 * $Id: class.tx_ptgsauserreg_gsa_ansch_id.php,v 1.4 2008/04/01 10:49:37 ry37 Exp $
 *
 * @author	Wolfgang Zenker <zenker@punkt.de>
 * @package	TYPO3
 * @subpackage	tx_ptgsauserreg
 */
class tx_ptgsauserreg_gsa_ansch_id {
    /**
     * itemsProcFunc callback function for tx_ptgsauserreg_gsa_ansch_id (called from ext_tables.php). Manipulates the item-array for table/field gsa_ansch_id.
     *
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pt_gsauserreg/class.tx_ptgsauserreg_gsa_ansch_id.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pt_gsauserreg/class.tx_ptgsauserreg_gsa_ansch_id.php']);
}
